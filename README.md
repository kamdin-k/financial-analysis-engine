...
A modern C++17 command-line system for processing financial transactions, calculating portfolio performance, and generating structured financial reports. The tool supports user-entered transaction data, dynamic tax-gain optimization using a DP-based subset selection algorithm, and formatted reporting suitable for audit or review.
...
- Automatic calculation of account balance and realized P&L  
